        ...
        <form method="post" action="" id="formularioModal" class="well form-horizontal">
                                ...
                                <div style='transition: 2s; display: none;background-color: #fafafa;width: 97%;border-radius: 19px;border: 1px solid #f0f0f0; margin: 15px 16px;' id='reasignar' class="container">
                                    ...
                                    <div class='row-fluid'>
                                        <div class='input-group'>
                                            ...
                                            <button style='margin-left: 20px;' type='submit' class='btn btn-success'  onclick="quitarRequired();
                                                    this.form.action = '<?= URL::to('SpecificService/reasign'); ?>'">Reasignar</button>
                                        </div>
                                        ...
                                        <div class="widget bg_white m-t-25 display-block">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group m-b-5">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select class="form-control m-b-5" id="state" name="state" onchange="validarEstado();">
                                                ...
                                                <br>
                                                <div class="form-group m-b-5" id="newObs" style="display: none;">
                                                    <label class="control-label col-md-3" for="observaciones">Observaciones: &nbsp;</label>
                                                    <div class="col-sm-8">
                                                        <textarea class="form-control m-b-5" rows="2" id="observaciones" name="observaciones" placeholder="Observaciones"></textarea>
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="form-group m-b-5">
            ...
            function validarEstado() {
                ...
                if (estado == "En proceso") {
                    $('#newObs').css('display', 'block');
                } else {
                    $('#newObs').css('display', 'none');
                }
            }
